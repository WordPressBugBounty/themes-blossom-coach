 ...
 * @return array
 */
if( ! function_exists( 'blossom_coach_get_sidebar_layout_data' ) ){
    function blossom_coach_get_sidebar_layout_data(){
        return array(
...
function blossom_coach_sidebar_layout_callback(){
    global $post;
    $blossom_coach_sidebar_layout = blossom_coach_get_sidebar_layout_data(  );
